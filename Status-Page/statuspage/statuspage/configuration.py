...
DATABASE = {
    'NAME': 'status-page',  # Default to 'status-page'
    'USER': 'alon',
    'PASSWORD': 'galandalon',
    'HOST': 'a-g-postgres-db.cx248m4we6k7.us-east-1.rds.amazonaws.com',
    'PORT': '5432',  # Default PostgreSQL port
    'CONN_MAX_AGE': 300,  # Default to 300 seconds
}
...
REDIS = {
    'tasks': {
        'HOST': 'a-g-redis-cluster.7fftml.0001.use1.cache.amazonaws.com',
        'PORT': 6379,
...
SECRET_KEY = os.getenv('SECRET_KEY', 'jj0-d+mHNKQx=vv%J1ItG6Lnkorzt@VQWigW65S@*W!nt%q0Ca')
